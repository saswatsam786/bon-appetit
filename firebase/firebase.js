...
import { getFirestore, writeBatch, doc, getDoc, query, collection, getDocs, where } from 'firebase/firestore'
...
export { db, auth, writeBatch, doc, getDoc, query, collection, getDocs, where }